            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {loading ? (
                    <tr>
                      <td colSpan={6} className="py-12 text-center text-[oklch(0.708_0_0)]">
                        Loading fact check history...
                      </td>
                    </tr>
                  ) : error ? (
                    <tr>
                      <td colSpan={6} className="py-12 text-center text-[oklch(0.645_0.246_16.439)]">
                        Error: {error}
                      </td>
                    </tr>
                    ...
                    paginatedClaims.map((claim) => (
                      <tr
                        ...
                        className={`border-b border-[oklch(0.269_0_0)] cursor-pointer transition-colors ${
                      ...
                      >
                        ...
                        <td className="py-3 px-4">
                          <span className={`text-sm font-medium ${
                            claim.viralityRisk > 6 ? "text-[oklch(0.645_0.246_16.439)]" :
